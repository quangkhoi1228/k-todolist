      ...
      {steps.map((step, index) => (
        ...
        >
          ...
          <div className="grid flex-1 grid-cols-2 gap-2">
            <Input
              placeholder="Tiêu đề bước (vd: Gửi tin nhắn xác nhận tiếp nhận)"
              value={step.title}
    ...
    <div className="flex flex-col items-center justify-center gap-3 py-20 text-center">
      ...
      <div>
        ...
        <p className="mt-1 max-w-sm text-xs text-muted-foreground">
          Tạo quy trình đầu tiên — ví dụ quy trình Kickoff, SOW, Gia hạn license
          firewall… Khi phân tích tin nhắn, PM Agent sẽ tham khảo kho này để đưa
          ra gợi ý phù hợp với quy trình.
        </p>
      </div>
    </div>
  );
      ...
      <div className="space-y-2">
        {isLoading ? (
          ...
          filtered.map((p) => {
            ...
            return (
              <div key={p._id} className="overflow-hidden rounded-xl border border-border/50 bg-card/40 dark:bg-zinc-800/40">
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5">
                        ...
                        {p.category && (
                          <span className="shrink-0 rounded-md bg-muted/60 px-1.5 py-0.5 text-[9px] font-semibold text-muted-foreground uppercase">
                            {p.category}
                          </span>
                        )}
                        {p.isActive === false && (
                          <span className="shrink-0 rounded-md bg-amber-500/10 px-1.5 py-0.5 text-[9px] font-semibold text-amber-600 dark:text-amber-400">
                            Tạm ẩn
                          </span>
                        )}
                      </div>
        ...
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            <div>
              ...
              <Input
                placeholder="vd: Gia hạn license firewall"
                value={form.name}
